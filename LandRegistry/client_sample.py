...
#########My code starts####################
def LockAsset_LandRegistry(reg_no, owner, private_key,new_owner_smc, url,current_time):
    # Prepare the transaction payload
    payload = {
        'operation':'LockAsset',    
        'reg_no': reg_no,
...
def ClaimAsset_LandRegistry(reg_no, new_owner, private_key, secret_key,current_owner_smc, url,current_time):
    # Prepare the transaction payload
    payload = {
...
def RefoundAsset_LandRegistry(reg_no, new_owner, private_key,current_owner_smc,url,current_time):
    # Prepare the transaction payload
    payload = {
        'operation':'RefoundAsset',    
        'reg_no': reg_no,
        'new_owner': new_owner,
        'private_key':private_key,
        'current_owner_smc':current_owner_smc,
...
def main():
    ...
    parser.add_argument('action', choices=['register', 'setPrice','buyPrice', 'getDetails','LockAsset','ClaimAsset','RefoundAsset'], help='LandRegistry action')
    ...
    ### my functions starts
        ...
        LockAsset_LandRegistry(args.reg_no, args.owner,args.private_key,args.new_owner_smc,args.url, current_time)
        ...
        current_time = int(time.time())
        ClaimAsset_LandRegistry(args.reg_no, args.new_owner,args.private_key,args.secret_key,args.current_owner_smc,args.url,current_time)
    elif args.action == 'RefoundAsset':
        current_time = int(time.time())
        RefoundAsset_LandRegistry(args.reg_no, args.new_owner, args.private_key,args.current_owner_smc,args.url,current_time)
    ### my functions ends
